...
@section('content')
    <div class="container">
        <div>
            <a class="btn btn-primary {{$websites->count() >= 25 ? 'disabled' : ''}}" href="{{ route('personal.website.create') }}" role="button">+ Add website</a>
        </div>
                ...
                @foreach ($websites as $website)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-primary" href="{{ route('personal.website.show', $website->id) }}" role="button">Show</a>
                        </td>
                        <td class="text-center">
